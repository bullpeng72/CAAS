...
4. **Phase 3-5 재생성** (3분)
   ```bash
   caas generate-phase --phase 3 "..." --output ./customer-support-bot --force
   caas generate-phase --phase 4 "..." --output ./customer-support-bot --force
   caas generate-phase --phase 5 "..." --output ./customer-support-bot --force
   ```

5. **QA 및 배포** (1시간)
   ```bash
   caas qa validate-all --project ./customer-support-bot

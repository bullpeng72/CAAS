...
- ✅ **CLI 28개 명령어** - 완전한 CLI 인터페이스 (v0.4.0: 20→22→28개로 확장)
...
| **02** | [02_Installation_Guide.md](02_Installation_Guide.md) | 🔧 CAAS 설치 및 환경 설정 |
| **03** | [03_Quick_Start_Guide.md](03_Quick_Start_Guide.md) | 🚀 5분 빠른 시작 + 초보자 완전 가이드 (실전 검증) |

### 2️⃣ 사용 가이드 (User Guides)

| 번호 | 문서 | 설명 |
|------|------|------|
| **04** | [04_CLI_Usage_Guide.md](04_CLI_Usage_Guide.md) | 💻 CLI 28개 명령어 완전 레퍼런스 |
| **05** | [05_Expert_Methodology_Guide.md](05_Expert_Methodology_Guide.md) | 🎓 대규모 프로덕션 시스템 구축 전략 (고급) |

### 3️⃣ 시스템 문서 (System Documentation)

| 번호 | 문서 | 설명 |
|------|------|------|
| **06** | [06_Architecture_Guide.md](06_Architecture_Guide.md) | 🏗️ CAAS 시스템 아키텍처 및 설계 |
| **07** | [07_Deployment_Guide.md](07_Deployment_Guide.md) | 🚢 프로덕션 배포 및 운영 가이드 |
| **08** | [08_Integration_Guide.md](08_Integration_Guide.md) | 🔗 Frontend-Backend 통합 패턴 |

### 4️⃣ 기능별 가이드 (Feature Guides)

| 번호 | 문서 | 설명 |
|------|------|------|
| **09** | [09_API_Key_Management.md](09_API_Key_Management.md) | 🔑 40+ CrewAI 도구 API 키 설정 |
| **10** | [10_Tool_Mapping.md](10_Tool_Mapping.md) | 🛠️ 도구 자동 매핑 및 추천 시스템 |
| **11** | [11_Artifact_Generation.md](11_Artifact_Generation.md) | 📄 10가지 개발 문서 자동 생성 |
| **12** | [12_Requirement_Refinement.md](12_Requirement_Refinement.md) | 📝 요구사항 분석 및 TDD 통합 |
| **13** | [13_Progress_Tracking.md](13_Progress_Tracking.md) | 📊 5단계 진행률 추적 및 리포팅 |
...
1. **[02_Installation_Guide.md](02_Installation_Guide.md)** - CAAS 설치 (10분)
2. **[03_Quick_Start_Guide.md](03_Quick_Start_Guide.md)** - 5분 빠른 시작 + 상세 가이드 (20분)
3. **[04_CLI_Usage_Guide.md](04_CLI_Usage_Guide.md)** - CLI 명령어 익히기 (10분)
...
1. **[02_Installation_Guide.md](02_Installation_Guide.md)** - 개발 환경 설치
2. **[03_Quick_Start_Guide.md](03_Quick_Start_Guide.md)** - 워크플로우 체험
3. **[05_Expert_Methodology_Guide.md](05_Expert_Methodology_Guide.md)** - CAAS 6-Phase 프로세스
4. **[04_CLI_Usage_Guide.md](04_CLI_Usage_Guide.md)** - CLI 마스터하기
5. **[06_Architecture_Guide.md](06_Architecture_Guide.md)** - 시스템 구조 이해
...
1. **[02_Installation_Guide.md](02_Installation_Guide.md)** - 설치
2. **[04_CLI_Usage_Guide.md](04_CLI_Usage_Guide.md)** - CLI 자동화
3. **[07_Deployment_Guide.md](07_Deployment_Guide.md)** - 프로덕션 배포
4. **[13_Progress_Tracking.md](13_Progress_Tracking.md)** - 모니터링
...
1. **[06_Architecture_Guide.md](06_Architecture_Guide.md)** - 전체 시스템 아키텍처
2. **[05_Expert_Methodology_Guide.md](05_Expert_Methodology_Guide.md)** - CAAS 6-Phase Methodology 및 고급 기법
3. **[08_Integration_Guide.md](08_Integration_Guide.md)** - 생성된 프로젝트 통합 패턴
4. **[07_Deployment_Guide.md](07_Deployment_Guide.md)** - 배포 전략
...
**[02_Installation_Guide.md](02_Installation_Guide.md)** - 완전한 설치 가이드
...
**[03_Quick_Start_Guide.md](03_Quick_Start_Guide.md)** - 실전 검증된 완전 가이드
...
**[04_CLI_Usage_Guide.md](04_CLI_Usage_Guide.md)** - CLI 완전 레퍼런스
- 28개 명령어 상세 설명
- 옵션 및 플래그 레퍼런스
- 실전 예시 및 유스케이스
- CLI 치트시트

**[05_Expert_Methodology_Guide.md](05_Expert_Methodology_Guide.md)** - 고급 개발 전략
- CAAS 6-Phase 상세 분석
...
**[06_Architecture_Guide.md](06_Architecture_Guide.md)** - 시스템 아키텍처
...
**[07_Deployment_Guide.md](07_Deployment_Guide.md)** - 프로덕션 배포
...
**[08_Integration_Guide.md](08_Integration_Guide.md)** - Frontend-Backend 통합
- 생성된 프로젝트 통합 아키텍처
...
**[09_API_Key_Management.md](09_API_Key_Management.md)** - API 키 설정
- 40+ CrewAI 도구 API 키 매핑
- .env 파일 관리
- CLI 환경 변수 명령어
- 보안 모범 사례

**[10_Tool_Mapping.md](10_Tool_Mapping.md)** - 도구 자동 매핑
- 온톨로지 기반 도구 추천
- 40+ 도구 카테고리별 분류
- 한국어 도구명 지원 (18개 번역 쌍)
- AI 자동 추천 알고리즘
...
**[11_Artifact_Generation.md](11_Artifact_Generation.md)** - 개발 문서 자동 생성
- **10가지 산출물 타입**:
  - 프로젝트 기획서 (PRD)
  - 요구사항 명세서 (SRS)
  - 아키텍처 설계서 (SAD)
...
**[12_Requirement_Refinement.md](12_Requirement_Refinement.md)** - 요구사항 개선 & TDD
...
**[13_Progress_Tracking.md](13_Progress_Tracking.md)** - 진행률 보고 시스템
- **5단계 Verbosity 레벨**:
  - QUIET (에러만)
  - MINIMAL (Phase 전환)
  - NORMAL (기본, Agent 실행)
...
1. **[02_Installation_Guide.md](02_Installation_Guide.md)** - CAAS 설치 (10분)
2. **[03_Quick_Start_Guide.md](03_Quick_Start_Guide.md)** - 첫 프로젝트 생성 (20분)
3. **[04_CLI_Usage_Guide.md](04_CLI_Usage_Guide.md)** - CLI 명령어 익히기 (10분)
...
```
caas/
├── caas_framework/      # 핵심 프레임워크 (86,000+ 라인)
...
│   ├── refinement/     # 요구사항 정제
│   └── ...
├── caas_cli/           # CLI 인터페이스 (29 명령어)
├── caas_sdk/           # Python SDK
├── data/               # 템플릿, 온톨로지, 예제
├── docs/               # 한국어 문서 (15개)
├── scripts/            # 유틸리티 스크립트
└── tests/              # 테스트 스위트 (160+ tests, v0.4.1: +60개, E2E 예제 포함)
```

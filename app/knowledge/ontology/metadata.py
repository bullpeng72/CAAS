...
from app.knowledge.ontology.manager import AgentRole, TaskType
...
def get_all_roles_with_metadata() -> List[Dict[str, Any]]:
    ...
    from app.knowledge.ontology.manager import AgentRole, ROLE_TASK_MAPPINGS
...
def get_all_tasks_with_metadata() -> List[Dict[str, Any]]:
    ...
    from app.knowledge.ontology.manager import TaskType, TASK_TOOL_MAPPINGS

...
class ToolImplementation(BaseModel):
    ...
    description: str = Field(
        default="",
        description="Detailed description of this implementation"
    )
    requires_api_key: bool = Field(
        default=False,
        description="Whether this implementation requires an API key"
    )
    ...
    pros: List[str] = Field(
        ...
        description="Advantages of this implementation"
    )
    cons: List[str] = Field(
        default_factory=list,
...
class ConceptualTool(BaseModel):
    ...
    compatible_roles: List[str] = Field(
        default_factory=list,
        description="Agent roles that commonly use this tool"
    )
    compatible_tasks: List[str] = Field(
        default_factory=list,
        description="Task types that commonly use this tool"
    )
    ...
    def get_implementation(self, crewai_class: Optional[str] = None) -> Optional[ToolImplementation]:
        """
...
class ToolOntology(BaseModel):
    ...
    tools: List[ConceptualTool] = Field(
        default_factory=list,
        description="List of conceptual tools"
    )

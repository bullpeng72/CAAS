"""
Artifact Generator (Refactored) - Phase 1 Task P1.3

Key improvements:
- generate_all_artifacts(): 15 parameters → 1 parameter (context)
- _build_context(): 14 parameters → 2 parameters (artifact_type, context)
- Cleaner API, easier to test, better maintainability
"""
...
class ArtifactGenerator:
    ...
    # ========================================================================
    # REFACTORED: 15 parameters → 1 parameter (context)
    # ========================================================================
    ...
    def generate_all_artifacts(
        ...
        """
        모든 활성화된 산출물 생성 (Refactored: 1 parameter vs 15 parameters)
    ...
    # ========================================================================
    # REFACTORED: 14 parameters → 2 parameters (artifact_type, context)
    # ========================================================================
    ...
    def _build_context(
        ...
        """
        산출물 타입에 맞는 컨텍스트 구성 (Refactored: 2 parameters vs 14 parameters)

        Before:
            def _build_context(
                self, artifact_type, requirement, golden_data, bmad_mapping,
                agents, tasks, test_summary, test_results, coverage,
                validation_result, code_files, code_metrics, security_issues,
                performance_issues
            )
        ...
        After:
            def _build_context(self, artifact_type, context)

...
class TestMinimalToolAssigner:
    ...
    def test_analyze_description_multiple_tools(self):
        ...
        description = "Search for API documentation, read the file, and execute the command"
        tools = assigner._analyze_description(description)
    ...
    def test_assign_tools_for_all_agents(self):
        ...
        tasks = [
            ...
            {
                'agent': 'developer',
                'description': 'Write code and commit to git'
            },
            {
                'agent': 'writer',
                'description': 'Read the code and write documentation'
            }
        ]
    ...
    def test_filter_to_available_tools(self):
        ...
        tasks = [
            {
                'agent': 'agent1',
                'description': 'Search web, read files, and write code'
            }
        ]
    ...
    def test_optimize_agent_tools_function(self):
        ...
        tasks = [
            {
                'agent': 'researcher',
                'description': 'Search for documentation online'
            }
        ]
...
class TestToolAssignmentIntegration:
    ...
    def test_devops_workflow_example(self):
        ...
        tasks = [
            ...
            {
                'agent': 'tester',
                'description': 'Run tests using shell commands'
            },
            {
                'agent': 'deployer',

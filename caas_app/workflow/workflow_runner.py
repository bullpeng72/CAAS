...
from caas_app.core.bmad import BMADEngine, BMADContext
from caas_app.workflow.project_service import get_project_service
...
from caas_app.core.sdd.multi_spec import UIPage, UIComponent, UIComponentType
...
class WorkflowRunner:
    ...
    def _generate_frontend_sync(
        ...
        """
        try:
            from caas_app.codegen.multi_generator import MultiArtifactGenerator, FrontendSpec, FrontendFramework

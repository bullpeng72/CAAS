...
class BMADWorkflowBuilder:
    ...
    def _discovery_node(self, state: BMADWorkflowState) -> Dict[str, Any]:
        """Discovery 단계 노드"""
        from caas_app.llm.chains import RequirementAnalysisChain
    ...
    def _discovery_gate_node(self, state: BMADWorkflowState) -> Dict[str, Any]:
        ...
        from caas_app.core.quality_gate import QualityGate
    ...
    def _architecture_node(self, state: BMADWorkflowState) -> Dict[str, Any]:
        """Architecture 단계 노드"""
        from caas_app.llm.chains import SystemArchitectChain
    ...
    def _design_node(self, state: BMADWorkflowState) -> Dict[str, Any]:
        """Design 단계 노드"""
        from caas_app.llm.chains import AgentDesignChain, TaskDesignChain
        from caas_framework.models.analysis import RequirementAnalysis
    ...
    def _development_node(self, state: BMADWorkflowState) -> Dict[str, Any]:
        """Development 단계 노드"""
        from caas_app.llm.chains import SpecGenerationChain

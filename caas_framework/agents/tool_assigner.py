...
class MinimalToolAssigner:
    ...
    TOOL_KEYWORDS = {
        ...
        'file_read': [
            'read file', 'load file', 'open file', 'read from', 'read the',
            'read config', 'load data',
            '파일 읽', '파일 불러', '파일 열'
        ],
        'file_write': [
            'write file', 'save file', 'create file', 'write to', 'save to',
            'write the', 'save results', 'write results', 'write code',
            'write documentation', 'write doc', 'create doc', 'write a',
            'write blog', 'write post', 'write article',
            '파일 쓰', '파일 저장', '파일 생성', '저장'
        ],
        'http_client': [
            'api', 'http', 'rest', 'request', 'endpoint', 'fetch',
            'get data', 'post data', 'call api',
            'API 호출', 'HTTP 요청', '데이터 가져'
        ],
        'database': [
        ...
        'shell': [
            'command', 'shell', 'bash', 'execute', 'run command',
            'terminal', 'cli',
            '명령', '실행', '터미널', '쉘'
        ],
        'code_analysis': [
            'analyze code', 'parse', 'ast', 'lint', 'check syntax',
            'review code', 'inspect', 'analyze the code', 'check for issues',
            'check code', 'review the code',
            '코드 분석', '파싱', '검토', '검사'
        ],
        'git': [
        ...
        'package_manager': [
            'install', 'pip', 'npm', 'yarn', 'poetry', 'package',

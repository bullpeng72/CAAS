...
class DomainStrategyConfig(BaseModel):
    ...
    strategy: CodeGenStrategy = Field(description="코드 생성 전략")

    requires_agents: bool = Field(description="Agent 생성 필요 여부")

    requires_crud: bool = Field(description="CRUD API 생성 필요 여부")
    ...
    recommended_architecture: str = Field(description="권장 아키텍처 설명")

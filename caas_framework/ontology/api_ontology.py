...
RESOURCE_CONCEPT = Concept(
    ...
    relationships={"has_many": ["Endpoint"], "requires": ["Schema", "Validation"]},
...
AUTHENTICATION_CONCEPT = Concept(
    ...
    relationships={"required_by": ["Endpoint"], "has_one": ["User"]},
...
AUTHORIZATION_CONCEPT = Concept(
    ...
    relationships={"required_by": ["Endpoint"], "belongs_to": ["User"]},
...
SCHEMA_CONCEPT = Concept(
    ...
    relationships={"belongs_to": ["Resource", "Endpoint"], "requires": ["Validation"]},
...
VALIDATION_CONCEPT = Concept(
    ...
    relationships={"belongs_to": ["Schema", "Endpoint"]},
...
RATE_LIMIT_CONCEPT = Concept(
    ...
    relationships={"belongs_to": ["Endpoint", "User"]},
...
ERROR_HANDLING_CONCEPT = Concept(
    ...
    relationships={"belongs_to": ["Endpoint"]},
...
DOCUMENTATION_CONCEPT = Concept(
    ...
    relationships={"belongs_to": ["Endpoint", "Resource"], "requires": ["Schema"]},
...
VERSIONING_CONCEPT = Concept(
    ...
    relationships={"belongs_to": ["Endpoint", "Resource"]},
...
REST_CRUD_PATTERN = DesignPattern(
    ...
    benefits=["Standard HTTP methods", "RESTful design", "Predictable API structure"],
)
...
JWT_AUTH_PATTERN = DesignPattern(
    ...
    benefits=["Stateless authentication", "Secure token exchange", "Easy to scale"],
)
...
API_SECURITY_PATTERN = DesignPattern(
    ...
    benefits=["Protected endpoints", "Rate limit abuse", "Data validation"],
)
...
API_DOCUMENTATION_PATTERN = DesignPattern(
    ...
    benefits=["Self-documenting API", "Interactive testing", "Developer friendly"],
)
...
PAGINATION_PATTERN = DesignPattern(
    ...
    benefits=["Efficient data transfer", "Better performance", "Scalable responses"],
)

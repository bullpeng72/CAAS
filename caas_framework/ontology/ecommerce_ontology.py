...
CART_CONCEPT = Concept(
    ...
    typical_operations=["add_item", "remove_item", "update_quantity", "clear", "calculate_total", "checkout"],
...
ORDER_CONCEPT = Concept(
    name="Order",
    properties=["id", "customer_id", "total", "status", "shipping_address", "created_at", "updated_at"],
    relationships={
        "belongs_to": ["Customer"],
...
SHIPMENT_CONCEPT = Concept(
    name="Shipment",
    properties=["id", "order_id", "tracking_number", "carrier", "status", "shipped_at", "delivered_at"],
    relationships={
        "belongs_to": ["Order"]
    },

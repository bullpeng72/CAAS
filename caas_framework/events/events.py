...
def create_phase_event(
    ...
    **kwargs,
    ...
    return Event(type=event_type, data=event_data, source=phase_name, metadata=kwargs)


def create_validation_event(
    passed: bool, phase_name: str, issues: Optional[list] = None, **kwargs
) -> Event:
    """
...
def create_feedback_event(
    message: str, phase_name: str, feedback_type: str = "info", **kwargs
) -> Event:
    """
